...
/*
* la fonction await retourne une promesse
* la réponse restera dans un then hors cas spécifique où on peut le setter quelque part.
* */
...
const main = async () => {
    const res = apiResponse("https://jsonplaceholder.typicode.com/todos/1");
...
/*
exemple d'utilisation du useEffect avec un async dedans

useEffect(() => {
    (async () => {
        setData(await apiResponse("https://jsonplaceholder.typicode.com/todos/1"));
    })()
}, [])
*/
